import { Component, Renderer2, ViewChild, inject, effect } from '@angular/core';
...
export class AppLayout {
    ...
    // readonly connexionVerifiee = effect(() => {
    //     if (!this.authStore.loggedIn() || this.authStore.user().role != 1) {
